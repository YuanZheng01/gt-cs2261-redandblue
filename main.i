...
extern const unsigned int redandblue_sampleRate;
extern const unsigned int redandblue_length;
extern const signed char redandblue_data[];
# 41 "main.c" 2
# 1 "worldexecuteme.h" 1


extern const unsigned int worldexecuteme_sampleRate;
extern const unsigned int worldexecuteme_length;
extern const signed char worldexecuteme_data[];
# 42 "main.c" 2
# 1 "etherstrike.h" 1


extern const unsigned int etherstrike_sampleRate;
extern const unsigned int etherstrike_length;
extern const signed char etherstrike_data[];
# 43 "main.c" 2
...
# 1 "pause.h" 1
# 22 "pause.h"
extern const unsigned short pauseTiles[272];
...
# 1 "testMap1.h" 1
# 22 "testMap1.h"
extern const unsigned short testMap1Tiles[608];


extern const unsigned short testMap1Map[4096];


extern const unsigned short testMap1Pal[256];
# 54 "main.c" 2
# 1 "testMap2.h" 1
# 22 "testMap2.h"
extern const unsigned short testMap2Tiles[1184];


extern const unsigned short testMap2Map[1024];


extern const unsigned short testMap2Pal[256];
# 55 "main.c" 2
...
void initialize() {
    DMANow(3, splash, ((unsigned short *)0x5000000), 256);

    (*(volatile unsigned short *)0x4000000) = 0 | (1 << 8) | (1 << 9) | (1 << 12);
    (*(volatile unsigned short *)0x4000008) = 0 | ((1) << 2) | ((27) << 8) | (0 << 14);
    (*(volatile unsigned short *)0x400000A) = 0 | ((0) << 2) | ((28) << 8) | (0 << 14);
...
void goToSplash() {
    ...
    DMANow(3, splashTiles, &((charblock *)0x6000000)[0], 4544 / 2);
...
void goToMenu() {
    ...
    (*(volatile unsigned short *)0x4000008) = 0 | ((0) << 2) | ((28) << 8) | (0 << 14);


    DMANow(3, spritesheetPal, ((unsigned short *)0x5000200), 512 / 2);
    DMANow(3, spritesheetTiles, &((charblock *)0x6000000)[4], 32768 / 2);

    DMANow(3, menuPal, ((unsigned short *)0x5000000), 512 / 2);

    DMANow(3, menuTiles, &((charblock *)0x6000000)[0], 4192 / 2);
...
# 301 "main.c"
    if ((!(~(oldButtons) & ((1 << 6))) && (~buttons & ((1 << 6))))) {
        if (ins){
            ins = 0;
            ((unsigned short *)0x5000000)[2] = ((unsigned short *)0x5000000)[3];
            ((unsigned short *)0x5000000)[3] = ((unsigned short *)0x5000000)[4];
        }
    }
    ...
    if ((!(~(oldButtons) & ((1 << 7))) && (~buttons & ((1 << 7))))) {
        if (!ins){
            ins = 1;
            ((unsigned short *)0x5000000)[3] = ((unsigned short *)0x5000000)[2];
            ((unsigned short *)0x5000000)[2] = ((unsigned short *)0x5000000)[4];
        }
    }
...
void goToGame() {
    ...
    DMANow(3, gamePal, ((unsigned short *)0x5000000), 512 / 2);

    DMANow(3, gameTiles, &((charblock *)0x6000000)[0], 160 / 2);
...
void goToPause() {
    ...
    DMANow(3, pauseTiles, &((charblock *)0x6000000)[0], 544 / 2);
...
void goToRating() {
    hideSprites();
    DMANow(3, ratingPal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, ratingTiles, &((charblock *)0x6000000)[0], 2752 / 2);
    DMANow(3, ratingMap, &((screenblock *)0x6000000)[28], 2048 / 2);
    drawScore(240 / 2 + 40, 80);
    waitForVBlank();
    DMANow(3, shadowOAM, ((OBJ_ATTR *)(0x7000000)), 128);
    cheater = 0;
    state = RATING;
...
void rating() {
    ...
    if ((!(~(oldButtons) & ((1 << 3))) && (~buttons & ((1 << 3)))) || (!(~(oldButtons) & ((1 << 0))) && (~buttons & ((1 << 0)))) || (!(~(oldButtons) & ((1 << 1))) && (~buttons & ((1 << 1))))) {
        goToMenu();
    }
...
void goToInstruction() {
    ...
    DMANow(3, instructionTiles, &((charblock *)0x6000000)[0], 4512 / 2);
...
void goToTest() {
    ...
    DMANow(3, testMap1Pal, ((unsigned short *)0x5000000), 512 / 2);

    (*(volatile unsigned short *)0x4000008) = ((1) << 2) | ((23) << 8) | (0 << 14) | (0 << 7);
    (*(volatile unsigned short *)0x400000A) = ((0) << 2) | ((24) << 8) | (1 << 14) | (0 << 7);

    DMANow(3, testMap1Tiles, &((charblock *)0x6000000)[0], 1216 / 2);
    DMANow(3, testMap1Map, &((screenblock *)0x6000000)[24], 8192 / 2);
    (*(volatile unsigned short *)0x04000014) = hOff;
    (*(volatile unsigned short *)0x04000016) = vOff;

    DMANow(3, testMap2Tiles, &((charblock *)0x6000000)[1], 2368 / 2);
    DMANow(3, testMap2Map, &((screenblock *)0x6000000)[23], 2048 / 2);
...
void initPlayer() {
    ...
    hikari.worldCol = 160 / 2 - hikari.height / 2 + vOff;
    hikari.worldCol = 240 / 2 - hikari.width / 2 + hOff;
    hikari.aniCounter = 0;
    hikari.curFrame = 0;
    hikari.numFrames = 3;
...
void updatePlayer() {
    ...
    if ((~((*(volatile unsigned short *)0x04000130)) & ((1 << 4)))) {
        ...
        if (hikari.worldCol + hikari.width < (1024) - 1) {
            hikari.worldCol += hikari.cdel;
        }

        if (screenBlock < 27 && (hOff < ((1024) - 240)) && (hikari.worldCol - hikariOff > 240 / 3)) {
            hOff += hikari.cdel;
...
# 557 "main.c"
    if (hOff > 256) {
        ...
        (*(volatile unsigned short *)0x400000A) = ((0) << 2) | ((screenBlock) << 8) | (1 << 14) | (0 << 7);
    }
 ...
 *(unsigned short*)0x4000208 = 0;
    ...
    *((ihp*)0x03007FFC) = (ihp*) interruptHandler;
 *(unsigned short*)0x4000200 |= 1 << 0;
 *(unsigned short*)0x4000004 |= 1 << 3;


    *(unsigned short*)0x4000200 |= 1 << 12;
    (*(volatile unsigned short *)0x04000132) |= (1 << 0) | (1 << 1) | (1 << 6) | (1 << 7) | (1 << 5) | (1 << 4) | (1 << 2) | (1 << 3) | 1 << 14;
 ...
 *(unsigned short*)0x4000208 = 0;
    ...
    if ((state == GAME)) {
        if (((unsigned short *)0x5000000)[1] > 0) {
            colorDecay(&((unsigned short *)0x5000000)[1]);
        }
        if (((unsigned short *)0x5000000)[2] > 0) {
            colorDecay(&((unsigned short *)0x5000000)[2]);
        }

        if (((unsigned short *)0x5000000)[3] > 0) {
            colorDecay(&((unsigned short *)0x5000000)[3]);
        }
    }
    if (state == GAME && (*(volatile unsigned short*)0x4000202 & 1 << 12) && (~(*(volatile unsigned short *)0x04000130) & ((1 << 0) | (1 << 1)))) {
        ((unsigned short *)0x5000000)[2] = ((unsigned short *)0x5000000)[4];
    }

    if (state == GAME && (*(volatile unsigned short*)0x4000202 & 1 << 12) && (~(*(volatile unsigned short *)0x04000130) & ((1 << 6) | (1 << 7) | (1 << 5) | (1 << 4)))) {
...
void colorDecay(u16* color) {
    ...
    *color = (((red >> 3) & 31) | (((green >> 3) & 31) << 5) | (((blue >> 3) & 31) << 10));
}
